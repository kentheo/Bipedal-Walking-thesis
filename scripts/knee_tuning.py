...
if __name__=="__main__":
    ...
    while True:
        ...
        # PD Controllers
        hip_todo[0] = 4.5*(hip_targ[0] - s[4]) - 0.85*x_ft[0][1] #s[5]  # hip angle/hip speed leg 1
        hip_todo[1] = 4.5*(hip_targ[1] - s[9]) - 0.85*x_ft[2][1] #s[10] # hip angle/hip speed leg 2
    ...
    if plot_flag == "hip filters":
        ...
        plt.xlabel("Time (s)", fontsize=12)
        plt.ylabel("Hip1 angular velocity", fontsize=12)
        ...
        plt.xlabel("Time (s)", fontsize=12)
        plt.ylabel("hip angle", fontsize=12)
        ...
        plt.xlabel("Time (s)", fontsize=12)
        plt.ylabel("Hip1 actual angle and filter", fontsize=12)
        plt.legend([red, (red, green)], ["Raw", "Filtered"])
        fig7.show()
    if plot_flag == "knee filters":
        ...
        plt.xlabel("Time (s)", fontsize=12)
        plt.ylabel("Knee angular velocity (rad/s)", fontsize=12)
        plt.legend([red, (red, green)], ["Raw", "Filtered"])
        fig1.show()
        ...
        fig7 = plt.figure(7)
        red, = plt.plot(t_list, s6, 'r')
        green, = plt.plot(t_list, knee1_ang_filter, 'g')
        plt.xlabel("Time (s)", fontsize=12)
        plt.ylabel("Knee angle (rad)", fontsize=12)
        plt.legend([red, (red, green)], ["Raw", "Filtered"])
        fig7.show()
