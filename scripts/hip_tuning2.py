    ...
    def _reset(self):
        ...
        for i in [-1,+1]:
            ...
            lower = self.world.CreateDynamicBody(
                ...
                angle = (-math.pi/2+a_i),
                fixtures = fixtureDef(
                    shape=polygonShape(box=(LEG_W*8, LEG_H/2)),
                    density=1.0,
                    restitution=0.0,
                    categoryBits=0x0020,
                    maskBits=0x001)
...
if __name__=="__main__":
    ...
    while True:
        ...
        # PD Controllers
        hip_todo[0] = 22.5*(hip_targ[0] - s[4]) - 0.85*x_ft[0][1] #s[5]  # hip angle/hip speed leg 1
        hip_todo[1] = 22.5*(hip_targ[1] - s[9]) - 0.85*x_ft[2][1] #s[10] # hip angle/hip speed leg 2
